...
class AutoUpdater {
    ...
    async updateDataExtractors(change) {
        const extractorsPath = path.join(__dirname, '..', 'data-extractors');
        const updates = [];
    ...
    async updateContentBuilders(change) {
        const buildersPath = path.join(__dirname, '..', 'content-builders');
        const updates = [];
    ...
    async updateQualityControllers(change) {
        const controllersPath = path.join(__dirname, '..', 'quality-controllers');
        const updates = [];
    ...
    async updateFileGenerators(change) {
        const generatorsPath = path.join(__dirname, '..', 'file-generators');
        const updates = [];
    ...
    async updateTemplateProcessors(change) {
        const processorsPath = path.join(__dirname, '..', 'template-processors');
        const updates = [];
