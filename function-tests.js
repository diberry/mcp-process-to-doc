...
exports.testConfigurationLoading = testConfigurationLoading;
exports.testRunStateInitialization = testRunStateInitialization;
exports.testFilePreperation = testFilePreperation;
exports.testUrlConfiguration = testUrlConfiguration;
exports.runValidationTests = runValidationTests;
const config_js_1 = require("./automation/generate/src/config.js");
/**
...
async function testConfigurationLoading() {
    try {
        ...
        const config = (0, config_js_1.getRunConfiguration)();
 ...
 */
async function testRunStateInitialization() {
    try {
        ...
        console.error("❌ Run state initialization test failed:", error.message);
        return false;
    }
}
/**
 ...
 */
async function testFilePreperation() {
    try {
        ...
        console.error("❌ File preparation test failed:", error.message);
        return false;
    }
}
/**
...
async function testUrlConfiguration() {
    try {
        ...
        console.error("❌ URL configuration test failed:", error.message);
        return false;
    }
}
/**
